...
#if defined(WITH_HOMEWORKS)
#   include "homeworks/tema_list.h"
#endif
...
int main(int argc, char **argv)
{
    ...
    // Switch between tema1::MainEvent() and tema2::MainEvent() to switch games
    World* world = new tema2::MainEvent();
